...
namespace Eventix.Modules.UserModule.Service
{
    public class UserService : IUserService
    {
        ...
        public UserService(AppDbContext context, IWebHostEnvironment environment, IOptions<ApiSettings> apiSettings)
        {
            _context = context;
        ...
        public async Task<UserResponse> UploadAvatarAsync(Guid userId, UploadAvatarRequest request)
        {
            if (request.Avatar == null || request.Avatar.Length == 0)
                throw new BadRequestException(SystemError.BAD_REQUEST);
